...
import { Plus, X, Camera, ArrowLeft, Trash2, BookOpen, Telescope, Sparkles, ImageOff, Pencil } from "lucide-react";
...
export default function AstroAlbum() {
  ...
  function addEntry(entry) {
    const next = albums.map((a) =>
      a.id === activeAlbum.id
        ? { ...a, entries: [...a.entries, { id: crypto.randomUUID(), ...entry }] }
        : a
    );
    persist(next);
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        ...
        {view === "album" && activeAlbum && (
          <AlbumView
            ...
            onOpenEntry={(e) => setActiveEntry(e)}
      ...
      {showNewAlbum && (
        <Modal onClose={() => setShowNewAlbum(false)} title="Nuevo álbum">
          <NameForm
            ...
            onSubmit={() => createAlbum(newAlbumName)}
